...
API_ID = int(environ.get('API_ID', '15316095'))
API_HASH = environ.get('API_HASH', '6a293d116082b81260ac83d21f595ffa')
BOT_TOKEN = environ.get('BOT_TOKEN', "5438560080:AAF_XK_wa5aY0ZdVPabW2Q1HZVJQYndWOU0")
...
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001886911325))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 'https://t.me/jannygrouo')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/cynitemovies/3')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001684512737))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001684512737))
...
# Delete Time
DELETE_TIME = int(environ.get('DELETE_TIME', 20))
SPL_DELETE_TIME = int(environ.get('SPL_DELETE_TIME', 15))

# URL SHORTNER

URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'mdisk.pro')
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '766185149277536bd3b9bbf1ccc75cb97a411729')
